...
const cacheName = 'LAWk7Brody-2021-04-07 16:06:39.228995'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk7Brody'.length) === 'LAWk7Brody') {
